...
const countries = [
  ...
  for (country of countries) {
    const option = `
      <li class="option">
          ...
          <strong style="display: none;">+${country.phone}</strong>
      </li> `;
  ...
  function selectOption() {
    ...
    const icon = this.querySelector(".iconify").cloneNode(true),
      phone_code = this.querySelector("strong").innerText; // Now using innerText directly

    selected_option.innerHTML = "";
    selected_option.append(icon);

    input_box.value = phone_code; // Add the hidden phone code to the input value
